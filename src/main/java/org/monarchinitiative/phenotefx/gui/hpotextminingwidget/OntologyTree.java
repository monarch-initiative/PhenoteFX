...
public class OntologyTree {
     ...
     * @param addHook  {@link Consumer} of {@link PhenotypeTerm}, an approved term will be submitted here
     */
    public OntologyTree(Ontology ontology, Consumer<PhenotypeTerm> addHook) {
    ...
    private void addButtonAction() {
        ...
        if (selected != null && addHook != null) {
            PhenotypeTerm phenotypeTerm = new PhenotypeTerm(selected.getValue(), !notPresentCheckBox.isSelected());
    ...
    public void initialize() {
        ...
        if (ontology != null) {
            ...
            TreeItem<Term> root = new TermTreeItem(ontology.getTermMap().get(ontology.getRootTermId()));
